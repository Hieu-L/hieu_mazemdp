...
class Maze:  # describes a maze-like environment
    def __init__(
        ...
        :param last_states: List defining the next states corresponding to the step before the end of an episode
        """
        self.width = width
        self.height = height
    ...
    def init_transitions(self, hit):
        ...
        transition_matrix = np.empty(
            (self.nb_states, self.action_space.n, self.nb_states)
        )
